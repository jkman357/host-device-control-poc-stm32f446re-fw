...
- Current firmware implementation baseline: v0.2.3
...
The v0.2.0 wire-protocol replacement remains intact in v0.2.3. The Coding Rules controls continue to cover
